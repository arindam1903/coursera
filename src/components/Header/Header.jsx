    ...
    <header>
      <div id="nav1">
        ...
        <img
          ...
          alt="coursera-logo"
        />
        <button id="explore-button" className="blue-button">
          <b>Explore</b>
          <AiOutlineDown />
        </button>
        <div id="search-bar">
          {" "}
          <input id="search" placeholder="What do you want to learn?" />
          <button id="search-button" className="blue-button">
            <FiSearch />
          </button>
        </div>
      </div>
      ...
      <div id="nav2">
        ...
        <span>
          <button id="join-button" className="blue-button">
            Join for Free
          </button>
        </span>
      </div>
